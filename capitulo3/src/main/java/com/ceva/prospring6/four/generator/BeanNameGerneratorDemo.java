package com.ceva.prospring6.four.generator;
...
class SimpleBeanNameGenerator extends AnnotationBeanNameGenerator {
    /*
     * Retornamos el nombre del bean compuesto por:
     * Nombre de la clase simple en minuscula concatenado con un id unico
     */
    @Override
