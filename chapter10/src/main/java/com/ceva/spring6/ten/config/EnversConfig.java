...
@ComponentScan(basePackages = {"com.ceva.spring6.ten"})
@EnableJpaRepositories("com.ceva.spring6.ten.repos")
public class EnversConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.ceva.spring6.ten.entities");
